...
PushNotification.localNotification({
	...
	largeIcon: "ic_launcher", // (optional) default: "ic_launcher". Can be http URL or file://. If null, it will not be set.
	largeIconCircular: true, // (optional) default: true. ignored if largeIcon is not a URL or file://
